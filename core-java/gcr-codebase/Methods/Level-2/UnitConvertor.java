public class UnitConvertor {
    ...
    public static void main(String[] args) {
        // Demo outputs for sample values
        System.out.println("10 km -> miles: " + convertKmToMiles(10));
        System.out.println("5 miles -> km: " + convertMilesToKm(5));
        System.out.println("2 meters -> feet: " + convertMetersToFeet(2));
        System.out.println("6 feet -> meters: " + convertFeetToMeters(6));
        System.out.println("100 fahrenheit -> celsius: " + convertFahrenheitToCelsius(100));
        System.out.println("37 celsius -> fahrenheit: " + convertCelsiusToFahrenheit(37));
    }
}
